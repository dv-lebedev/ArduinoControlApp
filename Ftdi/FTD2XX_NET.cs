...
namespace FTD2XX_NET
{
    ...
    public class FTDI
    {
        ...
        #region SINGLETON
        private static FTDI instance = null;

        public static FTDI _Instance
        {
            get
            {
                if (instance == null)
        ...
        public enum FT_STATUS
        {
            ...
            /// <summary>
            /// End of file, in case of data coming from file stream
            /// </summary>
            EOF
        };
        ...
        //в отличии от OpenBySerialNumber вызывается FT_SetBitMode, иначе КИА "молчит"
        public FT_STATUS OpenBySerialNumberExtended(string serialnumber)
        {
            // Initialise ftStatus to something other than FT_OK
            FT_STATUS ftStatus = FT_STATUS.FT_OTHER_ERROR;
        ...
        public FT_STATUS OpenBySerialNumberExtended2(string serialnumber)
        {
            // Initialise ftStatus to something other than FT_OK
            FT_STATUS ftStatus = FT_STATUS.FT_OTHER_ERROR;
